# Instructions for formatting data for a bar chart visualization
barGraphIntstruction = r'''
  Where data is: {
    labels: string[]
...
# Instructions for formatting data for a horizontal bar chart visualization
horizontalBarGraphIntstruction = r'''
  Where data is: {
    labels: string[]
    values: {\data: number[], label: string}[]
  }
...
# Instructions for formatting data for a line chart visualization
lineGraphIntstruction = r'''
  Where data is: {
...
# Instructions for formatting data for a pie chart visualization
pieChartIntstruction = r'''
  Where data is: {
    labels: string
    values: number
  }[]
...
# Instructions for formatting data for a scatter plot visualization
scatterPlotIntstruction = r'''
Where data is: {
  series: {
...
# Dictionary mapping visualization types to their formatting instructions
graph_instructions = {
